...
import { LOGIN, POST_METHOD } from "../apis/apiHelper";
...
const LoginView = ({ isOTPRequired, onSuccess }) => {
    ...
    login(
      ...
      (response) => {
        if (response.code === 200) {
          ...
          document.getElementById("menu-user-name").innerHTML =
            response.data.user_name;
          document.getElementById("menu-user-action").innerHTML = "LOGOUT";
          if (isOTPRequired) {
            document.getElementById("signin-otp-container").style.display =
              "block";
            document.getElementById("signin-container").style.display = "none";
          } else {
            document.getElementById("normal-container").style.display = "block";
  ...
  return (
    <div style={{ width: "100%", height: "100%" }}>
        ...
        <div className="login-container">
          ...
          <div className="login-othersignin-container">
            <GoogleLogin
              ...
              render={(renderProps) => (
                <div
                  className="login-othersignin-circle"
            ...
            <FacebookLogin
              ...
              render={(renderProps) => (
                ...
                >
                  <img
                    className="login-othersignin-image"
                    src={facebook_icon}
                  />
                </div>
              )}
          ...
          <div className="login-notaccount-container">
            ...
            <div className="login-notaccount-link" onClick={show_signup}>
              Registrati
            </div>
          </div>
        </div>
      ...
      <div id="signin-otp-container" style={{ display: "none" }}>
        <OTPView page={"signin"} mobile_number={null} onSuccess={onSuccess} />
      </div>
    </div>
  );
};
