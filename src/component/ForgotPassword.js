...
import { FORGOT_PASSWORD, RESET_PASSWORD, POST_METHOD } from "../apis/apiHelper";
...
const ForgotPasswordView = ({
    ...
    const { sendRequest: forgotPasswordAPI, sendRequest: resetPasswordAPI, isLoading, error } = useHttp();
    ...
    function gotoResetPassword(){
        ...
        const confirm_password = document.getElementById("fp-confirm-password").value.trim();
    ...
    return (
        ...
        <div className="sign-container" id="fp-container">
            <div className="login-container">
                ...
                <input type="text" id="fp-email" className="login-input" placeholder="Email" />
                <input type="password" id="fp-password" className="login-input" placeholder="Nuova Password" />
                <input type="password" id="fp-confirm-password" className="login-input" placeholder="Conferma Nuova Password" />
                <button className="login-button" onClick={forgotPassword}>Recupera</button>
            </div>
        </div>
